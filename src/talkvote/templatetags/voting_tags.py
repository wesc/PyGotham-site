...
class ScoreForObjectNode(template.Node):
    ...
    def render(self, context):
        try:
            ...
            return ''
        context[self.context_var] = VoteRecord.objects.get_score(object)
        return ''
...
class ScoresForObjectsNode(template.Node):
    ...
    def render(self, context):
        try:
            ...
            return ''
        context[self.context_var] = VoteRecord.objects.get_scores_in_bulk(objects)
        return ''
...
class VoteByUserNode(template.Node):
    ...
    def render(self, context):
        try:
            ...
            return ''
        context[self.context_var] = VoteRecord.objects.get_for_user(object, user)
        return ''
...
class VotesByUserNode(template.Node):
    ...
    def render(self, context):
        try:
            ...
            return ''
        context[self.context_var] = VoteRecord.objects.get_for_user_in_bulk(objects, user)
        return ''
