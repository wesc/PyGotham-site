...
class ConfRegForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['read_the_policy'].label = mark_safe(_("Yes, I've read <a href=\"%s/access/#diversity\">this conference policy statement</a>." % settings.SSL_MEDIA_URL))
        ...
        self.fields['assistance'].label = mark_safe(_('Please list any accessibility accomodations you may need. This could be as simple as needing a reserved seat at the front of each talk/class. Read <a href=\"%s/access/#accessibility\"> this </a>for details.' % settings.SSL_MEDIA_URL))
