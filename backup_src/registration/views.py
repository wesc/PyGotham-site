...
from captcha_validation import submit, RecaptchaResponse
...
def register(request, backend, success_url=None, form_class=None,
    ...
    **Template:**
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            result = submit(request.POST['recaptcha_challenge_field'], request.POST['recaptcha_response_field'],RECAPTCHA_PRIVATE_KEY,'www.google.com') 
            if result.is_valid:
