...
PAY_CHOICES = (
    ...
    ('need_sponsorship', mark_safe(_("I cannot afford this fee. I need my registration sponsored, and I've read <a href=\"%s/sponsors/#sponsored\">this sponsorship statement</a>." % settings.SSL_MEDIA_URL))),
