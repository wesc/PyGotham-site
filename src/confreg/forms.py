...
class ConfRegForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['spneeds'].label = mark_safe(_('Please list any accessibility accomodations you may need.<br>This could be as simple as needing a reserved seat at the front of each talk/class. Read <a href=\"%s/accessibility\"> this </a>for details.' % settings.SSL_MEDIA_URL))
